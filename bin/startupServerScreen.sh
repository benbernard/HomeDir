...
tmux set-window-option -t servers allow-rename off

tmux send-keys -t 0 'cdcl; foreman start web' Enter
tmux send-keys -t 1 'cdcl; foreman start worker' Enter
tmux send-keys -t 2 'cdcl; foreman start pgBridge' Enter
tmux send-keys -t 3 'cdcl; foreman start valueCleaner' Enter
