...
if [[ -n "$CODEX_SHELL" ]]; then
  setenv LS_COLORS 'no=00:fi=00:di=01;34:ln=01;35:or=01;31:ex=01;32:*.tar=01;31:*.tgz=01;31:*.zip=01;31:*.gz=01;31:*.bz2=01;31:*.xz=01;31:*.jpg=00;35:*.jpeg=00;35:*.gif=00;35:*.png=00;35:*.pdf=00;35:*.md=00;34:*.ts=00;33:*.js=00;33:*.json=00;36:*.yml=00;36:*.yaml=00;36'
...
if [[ -n "$CODEX_SHELL" ]]; then
  export FZF_DEFAULT_OPTS="${FZF_DEFAULT_OPTS} --color=fg:16,bg:231,hl:25,fg+:16,bg+:254,hl+:25,info:240,prompt:28,pointer:124,marker:124,spinner:28,header:240,border:250"
fi
